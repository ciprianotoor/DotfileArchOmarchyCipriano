# Utilidades de Omarchy

- `system-info.sh`: resumen de Arch, Omarchy, kernel y red.
- `disk-health.sh`: consulta y pruebas SMART no destructivas. Requiere `smartmontools`.
- `mount-media.sh`: monta, desmonta o expulsa medios mediante `udisks2`.
- `system-status.sh`: estado de Arch, Omarchy, red, Tailscale y actualizaciones pendientes.
